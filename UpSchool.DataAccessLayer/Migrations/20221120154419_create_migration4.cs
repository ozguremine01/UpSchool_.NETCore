...
{
    public partial class create_migration4 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EmploeeEmployeeID = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_EmployeeTasks_Emploees_EmploeeEmployeeID",
                        column: x => x.EmploeeEmployeeID,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmployeeTasks_EmploeeEmployeeID",
                table: "EmployeeTasks",
                column: "EmploeeEmployeeID");
